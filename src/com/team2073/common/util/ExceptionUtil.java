...
public class ExceptionUtil {
	...
	/**
	 * A fake logger so you don't need to pull in the logback and slf4j libraries.
	 */
	private static class Logger {

		public void error(String string, String methodName, String additionalMessage, Exception e) {
			System.err.println(string.replace("{}", methodName));
			System.out.println(Arrays.toString(e.getStackTrace()));
		}

		public void error(String string, String methodName, Exception e) {
			System.err.println(string.replace("{}", methodName));
			System.out.println(Arrays.toString(e.getStackTrace()));
		}
